              ...
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1">
                  ...
                  <div className="mt-3 rounded-md border border-border bg-card p-3 text-xs space-y-1">
                    ...
                    <p><span className="text-muted-foreground">Banco:</span> [Tu banco]</p>
                    <p><span className="text-muted-foreground">Titular:</span> [Tu nombre]</p>
                    <p><span className="text-muted-foreground">Cuenta:</span> [Tu número de cuenta]</p>
                    <p><span className="text-muted-foreground">CLABE:</span> [Tu CLABE interbancaria]</p>
